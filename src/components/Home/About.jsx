            ...
            <Row>
              <Col md={8} className="home-about-description">
                ...
                <p className="home-about-body">
                 Hi, my name is <span className="yellow">NOAURI Abderrazzak </span>
              
                <br />
                <br />
                an enthusiastic Big Data & Cloud Computing Engineering student with a passion for computer science.
 JAVA, Cloud, and containers, and I find joy in exploring software architecture, Rust, and systems.
Beyond the world of computer science, my interests extend to startups, politics, and emerging technologies.
                ...
                <br />
                  ...
                  with <b className="yellow">Spring Boot,</b> and
                  <i>
                    <b className="yellow">
                      {" "}
